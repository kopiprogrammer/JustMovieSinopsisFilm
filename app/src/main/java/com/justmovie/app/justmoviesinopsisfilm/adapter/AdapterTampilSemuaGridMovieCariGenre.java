...
public class AdapterTampilSemuaGridMovieCariGenre extends RecyclerView.Adapter<AdapterTampilSemuaGridMovieCariGenre.ViewHolder>{
    ...
    public AdapterTampilSemuaGridMovieCariGenre(movie_genre_list tdp, ArrayList<HashMap<String, String>>list_data){
        this.context = tdp;
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.cvData.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ((movie_genre_list)context ).loadInterstitial();
