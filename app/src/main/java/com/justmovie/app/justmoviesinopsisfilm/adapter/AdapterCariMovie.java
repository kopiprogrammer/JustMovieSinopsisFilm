...
import com.justmovie.app.justmoviesinopsisfilm.frag_cari;
...
public class AdapterCariMovie extends RecyclerView.Adapter<AdapterCariMovie.ViewHolder>{
    ...
    public AdapterCariMovie(main_menu tdp, ArrayList<HashMap<String, String>>list_data){
        this.context = tdp;
