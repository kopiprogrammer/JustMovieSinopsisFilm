 ...
 */
public class frag_genre extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.frag_genre, container, false);

        recyclerView = (RecyclerView) view.findViewById(R.id.rvdatagenre);
    ...
    public void getData(){
        stringRequest = new StringRequest(Request.Method.GET, Konfigurasi.URL_MOVIE_GENRE_LIST, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for (int i = 0; i < jArr.length(); i++) {
                        ...
                        AdapterTampilSemuaGridGenre adapter = new AdapterTampilSemuaGridGenre((main_menu) getActivity(), list_data);
