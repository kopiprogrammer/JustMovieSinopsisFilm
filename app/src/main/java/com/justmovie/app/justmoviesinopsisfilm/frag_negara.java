 ...
 */
public class frag_negara extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.frag_negara, container, false);


        recyclerView = (RecyclerView) view.findViewById(R.id.rvdatanegara);
    ...
    public void getData(){
        stringRequest = new StringRequest(Request.Method.GET, Konfigurasi.URL_MOVIE_NEGARA_LIST, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for (int i = 0; i < jArr.length(); i++) {
                        ...
                        AdapterTampilSemuaGridNegara adapter = new AdapterTampilSemuaGridNegara((main_menu) getActivity(), list_data);
