...
public class AdapterTampilSemuaGridMovieCariNegara extends RecyclerView.Adapter<AdapterTampilSemuaGridMovieCariNegara.ViewHolder>{
    ...
    public AdapterTampilSemuaGridMovieCariNegara(movie_negara_list tdp, ArrayList<HashMap<String, String>>list_data){
        this.context = tdp;
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.cvData.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ((movie_negara_list)context ).loadInterstitial();
