...
import com.justmovie.app.justmoviesinopsisfilm.adapter.AdapterTampilSemuaGridMovieCariNegara;
...
public class movie_negara_list extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_movie_negara_list);

        Intent intent = getIntent();
        negara = intent.getStringExtra(Konfigurasi.KUNCI_NEGARA);
    ...
    public void getData(){
        stringRequest = new StringRequest(Request.Method.GET, Konfigurasi.URL_MOVIE_GENRE_LIST_CARI+negara, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for (int i = 0; i < jArr.length(); i++) {
                        ...
                        AdapterTampilSemuaGridMovieCariNegara adapter = new AdapterTampilSemuaGridMovieCariNegara(movie_negara_list.this, list_data);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(movie_negara_list.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }
        );
