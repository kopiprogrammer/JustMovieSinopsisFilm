...
import com.justmovie.app.justmoviesinopsisfilm.adapter.AdapterTampilSemuaGridMovieCariTahun;
...
public class movie_tahun_list extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_movie_tahun_list);

        Intent intent = getIntent();
        tahun = intent.getStringExtra(Konfigurasi.KUNCI_TAHUN);
    ...
    public void getData(){
        stringRequest = new StringRequest(Request.Method.GET, Konfigurasi.URL_MOVIE_GENRE_LIST_CARI+tahun, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for (int i = 0; i < jArr.length(); i++) {
                        ...
                        AdapterTampilSemuaGridMovieCariTahun adapter = new AdapterTampilSemuaGridMovieCariTahun(movie_tahun_list.this, list_data);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(movie_tahun_list.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }
        );
