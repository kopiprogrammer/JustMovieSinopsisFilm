...
import com.justmovie.app.justmoviesinopsisfilm.frag_top_weekly;
...
public class AdapterTampilSemuaGridMovie extends RecyclerView.Adapter<AdapterTampilSemuaGridMovie.ViewHolder>{
    ...
    public AdapterTampilSemuaGridMovie(main_menu tdp, ArrayList<HashMap<String, String>>list_data){
        this.context = tdp;
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.cvData.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
               // ((main_menu)context ).loadInterstitial();
